...
//        registry.addViewController("/oauth").setViewName("index");
...
//        registry.addRedirectViewController("/redirect-index-oauth", "/oauth");
        registry.addViewController("/auth/login").setViewName("login");
//        registry.addViewController("/oauth/login").setViewName("oauth-login");
