...
public class ResidentRestController {
    ...
    @PutMapping("/residents/add/account/{serialNumber}")
    public ResidentDto addAccount(@PathVariable("serialNumber") Long serialNumber,
                                  @RequestBody ResidentAccountRegister residentAccountRegister) {
        return residentService.addAccount(serialNumber, residentAccountRegister);
    }
}
